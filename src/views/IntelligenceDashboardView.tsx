...
export const IntelligenceDashboardView = () => {
    ...
    return (
        <div className="space-y-8 sm:space-y-10 pb-10 sm:pb-20">
            ...
            <div className="relative overflow-hidden bg-[#020617] border border-slate-800 rounded-3xl sm:rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-6 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-6 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                ...
                <div className="relative z-10 flex-1 w-full text-center md:text-left">
                    ...
                    <h1 className="text-2xl sm:text-3xl md:text-3xl font-black text-white uppercase italic tracking-tighter leading-none mb-4 md:whitespace-nowrap">
                ...
                <div className="relative z-10 flex flex-row items-center gap-4 sm:gap-8 bg-[#0F172A]/80 backdrop-blur-md p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-2xl md:rounded-2xl border border-slate-700/50 w-full md:w-auto justify-center sm:justify-start">
                    <div className="space-y-1 sm:space-y-2">
                        <p className="text-[8px] sm:text-[10px] font-black text-slate-500 uppercase tracking-widest">Meta</p>
                        <div className="flex items-end gap-1.5 sm:gap-2">
                            <span className="text-xl sm:text-3xl md:text-2xl font-black text-emerald-400 tracking-tighter">84%</span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                {[
                    ...
                    <motion.div 
                        ...
                        className={`bg-[#0B0F19] p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-2xl md:rounded-2xl shadow-xl border border-slate-800 flex flex-col md:flex-row items-center md:items-start lg:items-center gap-3 sm:gap-4 md:gap-6 group hover:border-${stat.color}-500/50 transition-all cursor-default relative overflow-hidden`}
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <motion.div 
                    ...
                    className="lg:col-span-2 bg-[#0B0F19] p-6 sm:p-8 md:p-6 rounded-3xl sm:rounded-2xl md:rounded-3xl border border-slate-800 shadow-xl relative overflow-hidden"
                >
                ...
                <motion.div 
                    initial={{ opacity: 0, scale: 0.98 }}
                    animate={{ opacity: 1, scale: 1 }}
                    className="bg-[#0B0F19] p-6 sm:p-8 md:p-6 rounded-3xl sm:rounded-2xl md:rounded-3xl border border-slate-800 shadow-xl flex flex-col"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                <motion.div 
                    initial={{ opacity: 0, y: 15 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="bg-[#0B0F19] p-6 sm:p-8 md:p-6 rounded-3xl sm:rounded-2xl md:rounded-3xl border border-slate-800 shadow-xl"
                >
                ...
                <motion.div 
                    initial={{ opacity: 0, y: 15 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="bg-gradient-to-br from-indigo-950 to-[#020617] p-6 sm:p-8 md:p-6 rounded-3xl sm:rounded-2xl md:rounded-3xl border border-indigo-900/50 shadow-[0_20px_50px_rgba(49,46,129,0.2)] text-white relative overflow-hidden"
                >
                    <div className="absolute top-0 right-0 p-6 opacity-[0.03] scale-125 sm:scale-150 transform translate-x-10 -translate-y-10 pointer-events-none">
                    ...
                    <div className="relative z-10 h-full">
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            <div className="p-4 sm:p-5 md:p-6 bg-[#020617]/50 backdrop-blur-sm rounded-2xl sm:rounded-2xl border border-indigo-500/20 hover:border-indigo-500/50 hover:bg-indigo-900/20 transition-all cursor-pointer group shadow-inner">
