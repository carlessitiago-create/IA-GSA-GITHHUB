...
export function GestaoClientesView() {
  ...
  return (
    <div className="responsive-container pb-10 sm:pb-20">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 sm:gap-8 bg-white p-6 sm:p-6 md:p-6 rounded-2xl sm:rounded-3xl md:rounded-3xl border border-slate-100 shadow-sm relative overflow-hidden group mb-6 sm:mb-10">
        ...
        <div className="space-y-2 sm:space-y-4 relative z-10 w-full lg:w-auto">
          ...
          <button 
            ...
            className="relative z-10 w-full lg:w-auto bg-[#0a0a2e] text-white px-6 sm:px-6 py-4 sm:py-6 rounded-xl sm:rounded-2xl font-black text-[9px] sm:text-xs uppercase tracking-[0.3em] flex items-center justify-center gap-2 sm:gap-4 hover:scale-105 active:scale-95 transition-all shadow-2xl shadow-blue-900/30 group"
          >
            {showAddUser ? (
      ...
      <AnimatePresence mode="wait">
        {showAddUser && (
          <motion.div 
            ...
            exit={{ opacity: 0, y: -20 }}
            className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden mb-10 border border-slate-100"
          >
      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-100 overflow-hidden shadow-xl transition-all">
        <div className="p-6 sm:p-6 border-b border-slate-50 bg-slate-50/50 flex flex-col lg:flex-row justify-between items-center gap-6 sm:gap-6">
          <div className="flex items-center gap-4 sm:gap-8 w-full lg:w-auto">
            <div className="size-12 sm:size-20 bg-blue-600 rounded-xl sm:rounded-2xl flex items-center justify-center text-white shadow-2xl shadow-blue-500/30 group transition-all shrink-0">
          ...
          <div className="relative w-full lg:w-[500px]">
            ...
            <input 
              ...
              className="w-full bg-white border border-slate-100 rounded-xl sm:rounded-2xl py-4 sm:py-6 pl-14 sm:pl-18 pr-6 sm:pr-10 text-[10px] sm:text-[13px] font-bold text-[#0a0a2e] placeholder:text-slate-300 focus:ring-8 focus:ring-blue-500/5 outline-none shadow-sm transition-all"
              value={searchTerm}
          ...
          <table className="w-full text-left border-collapse min-w-[1000px]">
            <thead>
              <tr className="bg-white text-slate-400 border-b border-slate-50">
                <th className="px-6 py-8 font-black uppercase text-[10px] tracking-[0.3em]">Identidade Digital</th>
                <th className="px-6 py-8 font-black uppercase text-[10px] tracking-[0.3em]">Nível Estratégico</th>
                <th className="px-6 py-8 font-black uppercase text-[10px] tracking-[0.3em]">Status</th>
                <th className="px-6 py-8 font-black uppercase text-[10px] tracking-[0.3em] text-right">Ações de Comando</th>
              </tr>
            </thead>
