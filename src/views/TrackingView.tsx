              ...
              <div className="flex flex-col gap-3">
                ...
                <button 
                  onClick={() => {
                    ...
                    navigator.clipboard.writeText(`${getPublicOrigin()}/?ref=${refId}`);
                  ...
                  {proc.status_financeiro === 'VENCIDO' && (
                    <div className="mt-8 bg-gradient-to-br from-emerald-600 to-emerald-800 p-8 rounded-2xl shadow-2xl text-white relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                        ...
                        <button 
                          onClick={() => {
                            navigator.clipboard.writeText(`Olá! Estou usando a GSA para recuperar meu crédito e recomendo. Use meu link para ganhar desconto: ${getPublicOrigin()}/?ref=${proc.cliente_id}`);
